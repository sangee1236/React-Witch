...
namespace ResourceManagement.API.Models.TimesheetEntry
{
    public class TimeSheetEntryModel
    {
        ...
        //        [HttpGet]
        //public IEnumerable<string> GetLogTimeList()
        //{
        //    //_timeSheetEntryRepository.GetAll().Join(_ResourceManagementContext.Resources, e =>e.Id=)

        //    //    var balance = (from a in _ResourceManagementContext.Resources
        //    //                   join c in _ResourceManagementContext.Projects on a.Id equals c.Id
